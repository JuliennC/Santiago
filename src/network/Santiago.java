...
public class Santiago extends UnicastRemoteObject implements SantiagoInterface {
	...
	public void metCanalEnEauAvecXY(String nomPartie, int x, int y, String position, String couleur) throws RemoteException{
		...
		for(Canal canal : p.getPlateau().getListeCanaux()){
        ...
        p.addModification(Static.modificationCannaux);
	}
	...
	public String joueurFaitUneOffre() throws RemoteException{		
		...
		if (offre < 0) {
			...
			return "0_Vous ne pouvez pas faire une offre supérieur à votre solde : "+joueur.getSolde()+".";
		} else {
			return "1_"+offre;
		}
	}
